...
import com.omnidroid.common.kotlin.calculateCrc32
import com.omnidroid.common.kotlin.toStringCRC32
import com.omnidroid.lib.storage.BaseStorageFile
import com.omnidroid.lib.storage.StorageFile
import com.omnidroid.lib.storage.scanner.SerialScanner
...
object DocumentFileParser {
    ...
    /* Finds a zip entry which we assume is a game. Omnidroid only supports single archive games,
