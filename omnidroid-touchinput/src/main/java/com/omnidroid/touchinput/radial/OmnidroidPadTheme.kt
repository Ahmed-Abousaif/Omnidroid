package com.omnidroid.touchinput.radial
...
val LocalOmnidroidPadTheme =
    compositionLocalOf<OmnidroidPadTheme> {
        error("OmnidroidPadTheme is missing")
    }
