...
import com.omnidroid.common.compose.textUnit
import com.omnidroid.touchinput.radial.LocalOmnidroidPadTheme

@Composable
fun OmnidroidButtonForeground(
...
fun OmnidroidButtonForeground(
    ...
    OmnidroidButtonForeground(
        modifier = modifier,
        pressed = pressed,
        label = { OmnidroidButtonForegroundLabel(label, labelScale, pressed) },
        icon = { OmnidroidButtonForegroundIcon(icon, iconScale, pressed) },
    )
}

@Composable
private fun BoxWithConstraintsScope.OmnidroidButtonForegroundIcon(
    icon: Int?,
    scale: Float,
...
@Composable
private fun BoxWithConstraintsScope.OmnidroidButtonForegroundLabel(
    label: String?,
    scale: Float,
    pressedState: State<Boolean>,
) {
    ...
    Text(
        ...
        text = label,
        color = LocalOmnidroidPadTheme.current.icons(pressedState.value),
