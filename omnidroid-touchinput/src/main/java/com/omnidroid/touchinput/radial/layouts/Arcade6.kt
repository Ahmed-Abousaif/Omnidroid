...
import com.omnidroid.touchinput.radial.layouts.shared.SecondaryButtonCoin
            ...
            OmnidroidControlFaceButtons(
                ...
                idsForegrounds =
                    persistentMapOf<Id.Key, @Composable (State<Boolean>) -> Unit>(
                        Id.Key(KeyEvent.KEYCODE_BUTTON_X) to { OmnidroidCentralButton(pressedState = it) },
                        Id.Key(KeyEvent.KEYCODE_BUTTON_A) to { OmnidroidCentralButton(pressedState = it) },
                        Id.Key(KeyEvent.KEYCODE_BUTTON_B) to { OmnidroidCentralButton(pressedState = it) },
                        Id.Key(KeyEvent.KEYCODE_BUTTON_Y) to { OmnidroidCentralButton(pressedState = it) },
                    ),
            )
        },
        secondaryDials = {
