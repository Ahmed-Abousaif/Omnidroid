...
import com.omnidroid.app.tv.input.TVGamePadBindingActivity
import com.omnidroid.app.tv.input.TVGamePadShortcutBindingActivity
...
class GamePadPreferencesHelper
    ...
    private fun addPreferenceCategoryForInputDevice(
        ...
        inputDevice.getOmnidroidInputDevice().getCustomizableKeys()
    ...
    private fun buildGamePadEnabledPreference(
        ...
        preference.setDefaultValue(inputDevice.getOmnidroidInputDevice().isEnabledByDefault(context))
